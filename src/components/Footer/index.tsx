...
const Footer = () => {
  ...
  return (
    ...
    <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
      ...
      <div className="max-w-[330px] w-full">
            <h2 className="mb-7.5 text-custom-1 font-medium text-[#cfff00]">
              {t("helpSupport")}
            </h2>
            ...
            <div className="flex items-center gap-4 mt-7.5">
              <a
                ...
                className="flex ease-out duration-200 hover:text-[#cfff00] text-[#E8E8E8]"
              >
                <svg
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col gap-3.5">
              <li>
                <a className="ease-out duration-200 hover:text-[#cfff00] text-[#E8E8E8]" href="#">
                  {t("myAccount")}
                </a>
              </li>
              <li>
              ...
              <li>
                <Link
                  ...
                  className="ease-out duration-200 hover:text-[#cfff00] text-[#E8E8E8]"
                >
                  {commonT("trackOrder")}
                </Link>
              </li>
  ...
  {/* 
          <div className="w-full sm:w-auto">
            <h2 className="mb-7.5 text-custom-1 font-medium text-[#cfff00] lg:text-right">
              {t("downloadApp")}
            </h2>
      ...
      {/* <!-- footer bottom start --> */}
      <div className="py-5 xl:py-7.5 bg-[#231f20] w-full">
  <div className="px-4 sm:px-8 xl:px-0 w-full">
    <div className="flex gap-5 flex-wrap items-center justify-between w-full">
      
      {/* الجزء الخاص بالحقوق */}
      <div className="bg-[#0380C8] py-4 px-6 text-center text-sm md:text-lg text-[#E8E8E8] w-full">
  <p>
    {t.rich("note", {
      year,
      developer: (chunk) => (
        <a
          ...
          className="text-[#cfff00] font-semibold hover:underline transition"
        >
          {chunk}
        </a>
      ),

...
const Header = () => {
  ...
  <div className="max-w-[1170px] mx-auto flex flex-wrap w-full items-center justify-between px-4 py-3 sm:px-7.5 xl:px-0">
  {/* --- الصف العلوي (للموبايل) / الهيدر الكامل (للديسكتوب) --- */}
  <div className="flex w-full items-center justify-between">
    {/* -- الجزء الأيسر: اللوجو والبحث للديسكتوب -- */}
    <div className="flex items-center gap-10">
      ...
      <div className="hidden lg:block">
        <form>
          <div className="flex w-[500px] items-center overflow-hidden rounded-lg border border-[#0380C8] bg-[#E8E8E8]">
            {/* ... محتوى فورم البحث للديسكتوب ... */}
            <input
    ...
    <div className="flex items-center">
      {/* أيقونات الموبايل فقط */}
      <div className="flex items-center gap-4 lg:hidden">
        <Link href={`/${locale}/contact`} aria-label="Contact Us">
        <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
        ...
        <button onClick={handleOpenCartModal} className="relative" aria-label="Open Cart">
        <svg
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
          ...
          <span className="absolute -top-2 -right-2 flex h-4.5 w-4.5 items-center justify-center rounded-full bg-[#B7DE11] text-2xs font-medium text-[#231f20]">
            {product.length}
          </span>
        </button>
      </div>
      ...
      <div className="hidden items-center gap-5 lg:flex">
        <Link href={`/${locale}/contact`} className="flex items-center gap-2.5">
        <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
          ...
          <div>
            <span className="block text-2xs font-medium uppercase text-[#E8E8E8]">{t("support")}</span>
            <p className="text-custom-sm font-medium text-[#E8E8E8]">{t("contactUs")}</p>
          </div>
        </Link>
        <Link href={`/${locale}/contact`} className="flex items-center gap-2.5">
        <svg
          ...
          <div>
            <span className="block text-2xs font-medium uppercase text-[#E8E8E8]">{t("complaintsSuggestions")}</span>
            <p className="text-custom-sm font-medium text-[#E8E8E8]">{t("contactUs")}</p>
          </div>
        </Link>
        ...
        <svg
          ...
          <div className="hidden lg:block">
            <span className="block text-2xs font-medium uppercase text-[#E8E8E8]">{commonT("cart")}</span>
            <p className="text-custom-sm font-medium text-[#E8E8E8]">
  ...
  {/* --- الصف السفلي: فورم البحث للموبايل فقط --- */}
  <div className="mt-4 w-full lg:hidden">
    <form>
      <div className="flex w-full items-center overflow-hidden rounded-lg border border-[#0380C8] bg-[#E8E8E8]">
        <div className="relative flex-1">
          <input
            type="search"
            placeholder={t("searchPlaceholder")}
            className="w-full bg-transparent py-3 px-4 text-[14px] font-medium text-[#231f20] placeholder:text-gray-500 outline-none"
          />
          <button
            aria-label="Search"
            className="absolute top-1/2 right-3 flex -translate-y-1/2 items-center justify-center text-[#231f20] transition-colors duration-200 hover:text-[#0380C8]"
          >
      ...
      <div className="border-t border-[#E8E8E8]">
        <div className="max-w-[1170px] mx-auto px-4 sm:px-7.5 xl:px-0">
          <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between">
            {/* <!--=== Main Nav Start ===--> */}
            <div className="w-full xl:w-full h-auto xl:h-auto py-2 flex items-center justify-between xl:py-0">
              {/* <!-- Main Nav Start --> */}

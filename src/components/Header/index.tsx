              ...
              <form>
                <div className="flex items-center">
                  ...
                  <div className="relative max-w-[333px] sm:min-w-[333px] w-full">
                    {/* <!-- divider --> */}
                    <span
                      className={`absolute left-0 top-1/2 -translate-y-1/2 hidden lg:inline-block w-px h-5.5 bg-gray-4`}
                    ></span>
                    <input
                      ...
                      autoComplete="off"
                      className="custom-search text-[11px] w-full  lg:rounded-r-[5px] bg-gray-1  lg:!border-l-0 border border-gray-3 py-2.5 pl-4 pr-10 outline-none ease-in duration-200"
                    />
          ...
          <div className="flex w-full lg:w-auto items-center gap-7.5">
            ...
            <div className="flex w-full lg:w-auto justify-between items-center gap-5">
              <div className="flex items-center gap-5">
                ...
                <div className="max-w-[200px] w-full lg:hidden">
                  <form>
                    <div className="flex items-center">
                      {locale === "en" && (
                        <CustomSelect
                      ...
                      <div className="relative w-full">
                        ...
                        <input
                          ...
                          placeholder={t("searchPlaceholder")}
                          autoComplete="off"
                          className="custom-search text-[11px] w-full rounded-r-[5px] bg-gray-1 !border-l-0 border border-gray-3 py-2.5 pl-4 pr-10 outline-none ease-in duration-200"
                        />
              ...
              <div className="flex items-center gap-3 md:hidden">
                ...
                >
                  <span className="inline-block relative">
                    ...
                    <span className="flex items-center justify-center font-medium text-2xs absolute -right-1.5 -top-1.5 bg-blue w-4 h-4 rounded-full text-white">
                      {product.length}
                    </span>
                  </span>
                </button>
                ...
                <ul className="flex items-center flex-row gap-3 sm:gap-4 xl:gap-6 overflow-x-auto xl:overflow-x-visible">
                  {menuData.map((menuItem, i) =>
                    menuItem.submenu ? (
                      ...
                      <li
                        key={i}
                        className=" group relative before:w-0 before:h-[3px] before:bg-blue before:absolute before:left-0 before:top-0 before:rounded-b-[3px] before:ease-out before:duration-200 hover:before:w-full flex-shrink-0"
                      >
                        <Link
                          href={`/${locale}/${menuItem.path}`}
                          className={`hover:text-blue text-[11px] sm:text-[12px] font-medium text-dark flex py-2 ${

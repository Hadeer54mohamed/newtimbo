      ...
      <div className="max-w-[1170px] mx-auto px-4 sm:px-7.5 xl:px-0 flex items-center justify-between py-3">
        <div className="xl:w-auto flex-col sm:flex-row w-full flex sm:justify-between sm:items-center gap-5 sm:gap-10">
          <div className="flex items-center justify-between gap-8 sm:gap-3">
            ...
            <div className="flex flex-1 items-center gap-2 sm:gap-3 lg:hidden">
              <div className="max-w-[200px] sm:max-w-[250px] w-full">
                <form>
                  <div className="flex items-center bg-[#E8E8E8] rounded-lg border border-[#0380C8] overflow-hidden">
                    ...
                    <div className="relative flex-1">
                      <input
                        ...
                        autoComplete="off"
                        className="w-full text-[12px] sm:text-[13px] bg-transparent text-[#231f20] py-2 px-2 sm:py-2.5 sm:px-3 outline-none font-medium placeholder:text-gray-500"
                      />
                      <button
                        id="search-btn-mobile"
                        aria-label="Search"
                        className="hidden lg:flex items-center justify-center absolute right-1 sm:right-2 top-1/2 -translate-y-1/2 text-[#231f20] hover:text-[#0380C8] transition-colors duration-200"
                      >
                        <svg
              ...
              <button
                ...
                className="flex items-center justify-center text-[#E8E8E8] hover:text-[#B7DE11] transition-colors duration-200"
              >
        ...
        <div className="hidden lg:flex w-full lg:w-auto items-center gap-7.5  pr-[50px]">
          ...
          <div className="w-full xl:w-full h-auto xl:h-auto py-0 flex items-center justify-between  xl:py-0">
            ...
            <div
              className={`hidden xl:flex items-center gap-3 ${
                locale === "ar" ? "order-1 mr-auto" : "order-2 ml-auto"
              }`}
            >

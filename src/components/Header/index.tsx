        ...
        >
          ...
          <div className="xl:w-auto flex-col sm:flex-row w-full flex sm:justify-between sm:items-center gap-5 sm:gap-10">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              {/* Mobile Search Input and Cart Icon */}
                    ...
                    <div className="flex items-center bg-[#E8E8E8] rounded-lg border border-[#0380C8] overflow-hidden">
                      ...
                      <div className="relative flex-1">
                        ...
                        <button
                          ...
                          aria-label="Search"
                          className="flex items-center justify-center absolute right-1 sm:right-2 top-1/2 -translate-y-1/2 text-[#231f20] hover:text-[#0380C8] transition-colors duration-200"
                        >
                          <svg

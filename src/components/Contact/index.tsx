...
const Contact = () => {
  ...
  return (
    <>
      <Breadcrumb title={t("title")} pages={["contact"]} />
        ...
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex flex-col xl:flex-row gap-7.5">
            <div className="xl:max-w-[370px] w-full bg-white rounded-xl shadow-1">
              ...
              <p className="font-semibold text-xl text-[#231f20]">
                  {t("contactInformation")}
                </p>
              </div>

              <div className="p-4 sm:p-7.5">
              <div className="flex flex-col gap-4 text-[#231f20]">
              ...
              <form>
                  ...
                  <div className="w-full">
                    ...
                    <input
                      ...
                      placeholder={t("firstNamePlaceholder")}
                         className="rounded-md border border-gray-3 bg-gray-1 placeholder:text-dark-5 w-full py-2.5 px-5 outline-none focus:border-transparent focus:ring-2 focus:ring-[#0380C8]/40"
                    />
                  </div>
                ...
                <div className="mb-7.5">
                  ...
                  <textarea
                    ...
                    className="rounded-md border border-gray-3 bg-gray-1 placeholder:text-dark-5 w-full p-5 outline-none focus:border-transparent focus:ring-2 focus:ring-[#0380C8]/40"
                    ></textarea>
                </div>

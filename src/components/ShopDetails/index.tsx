...
const ShopDetails = ({ productId }: ShopDetailsProps) => {
  ...
  useEffect(() => {
    ...
    const fetchAttributes = async () => {
      try {
        const attrs = await getProductAttributes(String(product.id));
        setAttributes(attrs || []);
      } catch (error) {
                      ...
                      >
                        <g clipPath="url(#clip0_375_9221)">
                          <path
                            ...
                            fill={
                              product.stock_quantity > 0 ? "#cfff00" : "#FF4444"
                            }
                          />
                          <path
                    ...
                    product.offer_price < product.price ? (
                      <>
                        <span className="text-lg sm:text-base text-dark">
                          ...
                          {product.offer_price} {locale === "ar" ? "ج.م" : "EGP"}
                        </span>
                        <span className="line-through text-dark-4 ml-2 mr-2 text-sm">
                          {locale === "ar" ? "السعر:" : "Price:"}{" "}
                          {product.price || 0} {locale === "ar" ? "ج.م" : "EGP"}
                        </span>
                      </>
                    ) : (
                      <span className="text-lg sm:text-base text-dark">

...
const NewArrival = () => {
  ...
  return (
    <section className="overflow-hidden pt-16 pb-10 bg-gradient-to-b from-white to-[#E8E8E8]/30">
      <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
        ...
        <div className="mb-10 flex items-center justify-between">
          <div>
            ...
            <h2 className="font-semibold text-2xl xl:text-3xl text-[#231f20]">
          ...
          <Link
            href={`/${locale}/shop`}
            className="inline-flex font-medium text-custom-sm py-3 px-7 sm:px-12.5 rounded-md border border-gray-3 text-gray-1 bg-green-dark ease-out duration-200 hover:bg-green hover:text-white hover:border-transparent"
>

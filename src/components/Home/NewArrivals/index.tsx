    ...
    <section className="overflow-hidden pt-16 pb-10 bg-gradient-to-b from-white to-[#E8E8E8]/30">
      <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
        ...
        <div className="mb-10 flex items-center justify-between">
          ...
          <Link
            href={`/${locale}/shop`}
            className="inline-flex font-medium text-sm py-2.5 px-7 rounded-lg 
             text-white bg-[#0380C8] border border-[#0380C8] 
             transition-all hover:bg-[#B7DE11] hover:text-[#231f20] hover:scale-105"
          >

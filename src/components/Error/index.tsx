...
const Error = () => {
  return (
    <>
      <Breadcrumb title={"404 - الصفحة غير موجودة"} pages={["خطأ"]} />
        ...
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <div className="bg-white rounded-xl shadow-1 px-4 py-10 sm:py-15 lg:py-20 xl:py-25">
            <div className="text-center">
              ...
              <p className="max-w-[410px] w-full mx-auto mb-7.5 text-gray-600">
                الصفحة التي تبحث عنها إما تم نقلها أو حذفها أو غير موجودة
              </p>
